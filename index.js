    ...
    siri.onresult = evt => {
        ...
        switch (listenedline) {
            ...
            case "open my website":
                window.open('file:///C:/Users/sac/Documents/Rwebsite/index.html');
                break
            ...
            case "":
                ...
                break;
            case "who are you":
                var s = "i am your persnol assistant "
                var synth = window.speechSynthesis;
                var utter = new window.SpeechSynthesisUtterance(s);
                synth.speak(utter);
                break;
            case "what is my brothers  name ":
            ...
            case "":
                ...
                synth.speak(utter);
                break;
            case "what is the formula of area of rectangle":
